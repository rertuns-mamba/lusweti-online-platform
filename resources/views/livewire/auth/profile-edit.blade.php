                ...
                <form wire:submit="updateProfile" class="space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            @error('name') <p class="mt-2 text-sm font-bold text-[#B80000]">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input wire:model="phone_number" id="phone_number" type="tel" 
                                   class="block w-full px-4 py-3 bg-white border border-gray-400 text-black rounded-none focus:outline-none focus:border-black focus:ring-1 focus:ring-black">
                            @error('phone_number') <p class="mt-2 text-sm font-bold text-[#B80000]">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="email" id="email" type="email" required 
                               class="block w-full px-4 py-3 bg-white border border-gray-400 text-black rounded-none focus:outline-none focus:border-black focus:ring-1 focus:ring-black">
                        @error('email') <p class="mt-2 text-sm font-bold text-[#B80000]">{{ $message }}</p> @enderror
                    </div>
                ...
                <form wire:submit="updatePassword" class="space-y-6">
                    <div class="space-y-2 max-w-md">
                        ...
                        <input wire:model="current_password" id="current_password" type="password" 
                               class="block w-full px-4 py-3 bg-white border border-gray-400 text-black rounded-none focus:outline-none focus:border-black focus:ring-1 focus:ring-black">
                        @error('current_password') <p class="mt-2 text-sm font-bold text-[#B80000]">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input wire:model="new_password" id="new_password" type="password" 
                                   class="block w-full px-4 py-3 bg-white border border-gray-400 text-black rounded-none focus:outline-none focus:border-black focus:ring-1 focus:ring-black">
                            @error('new_password') <p class="mt-2 text-sm font-bold text-[#B80000]">{{ $message }}</p> @enderror
                        </div>
