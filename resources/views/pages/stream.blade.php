<x-layouts.app :title="__('Stream')">
    <div x-data="livekitRoom({
        ...
        <header
            class="max-w-[1600px] mx-auto px-4 lg:px-6 rounded-b-lg border-b border-white/5 bg-slate-950 backdrop-blur-lg sticky top-0 z-40">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <section class="xl:col-span-9 space-y-4">
                    ...
                    <div x-data="streamPlayer">
                        ...
                        <div x-ref="fullscreenTarget" id="livekitPlayer" @dblclick="toggleFullscreen()"
                            ...
                            <div id="localVideo" class="w-full h-full">
                            </div>

                            <div id="remoteVideos" class="w-full h-full">
                            </div>
                            ...
                            <button @click="toggleFullscreen()" class="absolute bottom-5 right-5 z-30">
                ...
                <aside class="xl:col-span-3 space-y-4">
                    ...
                    <div class="bg-slate-900 rounded-3xl border border-white/5 h-[500px] flex flex-col overflow-hidden">
                        ...
                        <div wire:ignore class="flex-1 min-h-0 flex flex-col">
        ...
        <template x-if="isHost">
            <div
                class="fixed bottom-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-2xl border-t border-white/10 p-4">
                <div class="max-w-4xl mx-auto flex flex-col md:flex-row gap-6 items-center">
                    ...
                    <div class="flex gap-6 w-full md:w-auto">
                        <div class="flex flex-col">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full"
                                    :class="isLive ? 'bg-red-500 animate-pulse' : 'bg-slate-700'"></div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-sm font-mono font-medium text-slate-300"
                                x-text="recordingDuration"></span>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 flex gap-2 w-full md:w-auto">
                        ...
                        <button @click="toggleRecording()" :disabled="!isLive"
                            ...
                            :class="isRecording ? 'bg-red-500/20 text-red-400 border-red-500/30' :
                    ...
                    <template x-if="downloadUrl">
                        <div class="flex gap-2 w-full md:w-auto">
                            <a :href="cleanAudioUrl"
                                class="px-4 py-3 rounded-lg bg-emerald-900/30 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-900/50 text-[10px] font-bold uppercase tracking-widest transition-all">Audio</a>
                            <button @click="forceDownload()"
                                class="flex-1 px-4 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-500 text-[10px] font-bold uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)]">Download
                                Video</button>
                        </div>
                    </template>
                </div>
