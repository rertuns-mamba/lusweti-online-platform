<?php
if (!function_exists('_25226092a3c1fb07bcdbbf733061e04c')):
function _25226092a3c1fb07bcdbbf733061e04c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($label); ?><?php $__slotsb1608d23ae24763e292ace789f9492e8['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsb1608d23ae24763e292ace789f9492e8); ?>
<?php _b1608d23ae24763e292ace789f9492e8($__blaze, $__attrsb1608d23ae24763e292ace789f9492e8, $__slotsb1608d23ae24763e292ace789f9492e8, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php ob_start(); ?><?php echo e($description); ?><?php $__slots01ff82d895d944da3dc1d5e8a87ad469['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots01ff82d895d944da3dc1d5e8a87ad469); ?>
<?php _01ff82d895d944da3dc1d5e8a87ad469($__blaze, $__attrs01ff82d895d944da3dc1d5e8a87ad469, $__slots01ff82d895d944da3dc1d5e8a87ad469, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
        ...
        <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/error.blade.php', $__blaze->compiledPath.'/c3b3f60cef2b82e3d7e7854ab68e0624.php'); ?>
<?php $__blaze->pushData(['attributes' => new \Illuminate\View\ComponentAttributeBag($scope['attributes'])]); ?>
<?php _c3b3f60cef2b82e3d7e7854ab68e0624($__blaze, ['attributes' => new \Illuminate\View\ComponentAttributeBag($scope['attributes'])], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php $__slots01ff82d895d944da3dc1d5e8a87ad469 = []; ?>
<?php $__blaze->pushData($__attrs01ff82d895d944da3dc1d5e8a87ad469); ?>
<?php ob_start(); ?><?php echo e($descriptionTrailing); ?><?php $__slots01ff82d895d944da3dc1d5e8a87ad469['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots01ff82d895d944da3dc1d5e8a87ad469); ?>
<?php _01ff82d895d944da3dc1d5e8a87ad469($__blaze, $__attrs01ff82d895d944da3dc1d5e8a87ad469, $__slots01ff82d895d944da3dc1d5e8a87ad469, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack01ff82d895d944da3dc1d5e8a87ad469)) { $__slots01ff82d895d944da3dc1d5e8a87ad469 = array_pop($__slotsStack01ff82d895d944da3dc1d5e8a87ad469); } ?>
<?php if (! empty($__attrsStack01ff82d895d944da3dc1d5e8a87ad469)) { $__attrs01ff82d895d944da3dc1d5e8a87ad469 = array_pop($__attrsStack01ff82d895d944da3dc1d5e8a87ad469); } ?>
<?php $__blaze->popData(); ?>
        <?php endif; ?>
    <?php $__slots6a8a129e8cd55782099a29215785b823['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6a8a129e8cd55782099a29215785b823); ?>
<?php _6a8a129e8cd55782099a29215785b823($__blaze, $__attrs6a8a129e8cd55782099a29215785b823, $__slots6a8a129e8cd55782099a29215785b823, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\with-field.blade.php ENDPATH**/ ?>