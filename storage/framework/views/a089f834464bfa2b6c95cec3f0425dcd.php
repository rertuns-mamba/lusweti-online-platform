...
[$__name, $__params] = $__split('hover-cube', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1275181512-0', $__key);
...
?>
        ...
        <script>
            window.addEventListener('beforeunload', function() {
                ...
                navigator.sendBeacon('<?php echo e(route('stream.end', $stream->uuid)); ?>', data);
            });
        </script>
