<?php
if (!function_exists('_a89bb751bdfaad8d1baace3dd6aecb1a')):
function _a89bb751bdfaad8d1baace3dd6aecb1a($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _674a7ecd707d55f4e7014975fe11c342($__blaze, ['name' => $icon,'variant' => 'mini','class' => 'inline'], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\error.blade.php ENDPATH**/ ?>