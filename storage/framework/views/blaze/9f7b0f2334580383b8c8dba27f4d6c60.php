<?php
if (!function_exists('__9f7b0f2334580383b8c8dba27f4d6c60')):
function __9f7b0f2334580383b8c8dba27f4d6c60($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
$rounded ??= $attributes['rounded'] ?? $__defaults['rounded']; unset($attributes['rounded']);
...
<?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-div.blade.php', $__blaze->compiledPath.'/88fd82d362637cd5a0ebefc186fb2d4d.php'); ?>
<?php if (isset($__slots88fd82d362637cd5a0ebefc186fb2d4d)) { $__slotsStack88fd82d362637cd5a0ebefc186fb2d4d[] = $__slots88fd82d362637cd5a0ebefc186fb2d4d; } ?>
<?php if (isset($__attrs88fd82d362637cd5a0ebefc186fb2d4d)) { $__attrsStack88fd82d362637cd5a0ebefc186fb2d4d[] = $__attrs88fd82d362637cd5a0ebefc186fb2d4d; } ?>
<?php $__attrs88fd82d362637cd5a0ebefc186fb2d4d = ['attributes' => $attributes->class($classes),'dataFluxBadge' => true]; ?>
<?php $__slots88fd82d362637cd5a0ebefc186fb2d4d = []; ?>
<?php $__blaze->pushData($__attrs88fd82d362637cd5a0ebefc186fb2d4d); ?>
<?php ob_start(); ?>
...
<?php $__blaze->pushData(['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true]); ?>
<?php __674a7ecd707d55f4e7014975fe11c342($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php endif; ?>
<?php $__slots88fd82d362637cd5a0ebefc186fb2d4d['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots88fd82d362637cd5a0ebefc186fb2d4d); ?>
<?php __88fd82d362637cd5a0ebefc186fb2d4d($__blaze, $__attrs88fd82d362637cd5a0ebefc186fb2d4d, $__slots88fd82d362637cd5a0ebefc186fb2d4d, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack88fd82d362637cd5a0ebefc186fb2d4d)) { $__slots88fd82d362637cd5a0ebefc186fb2d4d = array_pop($__slotsStack88fd82d362637cd5a0ebefc186fb2d4d); } ?>
<?php if (! empty($__attrsStack88fd82d362637cd5a0ebefc186fb2d4d)) { $__attrs88fd82d362637cd5a0ebefc186fb2d4d = array_pop($__attrsStack88fd82d362637cd5a0ebefc186fb2d4d); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>