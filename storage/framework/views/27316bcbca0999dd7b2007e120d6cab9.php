    ...
    <div class="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800">
        <div class="flex items-center gap-3">
            ...
            <h3 class="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">
                <?php echo e(__('2FA Recovery Codes')); ?>
...
</div><?php /**PATH E:\livestream-apps\lusweti-online-center\resources\views\livewire\auth\settings\two-factor\recovery-codes.blade.php ENDPATH**/ ?>