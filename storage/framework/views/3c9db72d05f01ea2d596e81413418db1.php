        ...
        <div class="h-16 flex items-center justify-between">
            ...
            <div class="flex items-center justify-end gap-4 sm:gap-6 w-auto sm:w-1/3">
                ...
                <div class="relative flex-shrink-0" x-data="{ open: false }" @click.away="open = false">
                    <button @click="open = !open" class="flex items-center space-x-3 focus:outline-none p-1 group">
                        ...
                        <div class="h-8 w-8 sm:h-9 sm:w-9 bg-neutral-800 border border-neutral-700 flex items-center justify-center overflow-hidden group-hover:border-red-600 transition-colors flex-shrink-0">
                            ...
                            <img src="<?php echo e(Auth::user()->avatar_url); ?>" alt="Profile Avatar" class="h-full w-full object-cover">
                            <?php else: ?>
                            <span class="text-xs font-black tracking-wider text-red-500 uppercase"><?php echo e(Auth::user()->initials); ?></span>
                ...
                <div class="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                    <a href="<?php echo e(route('subscribe')); ?>" class="flex items-center gap-2 px-3 py-2 text-xs font-bold uppercase tracking-widest text-red-500 hover:text-red-400 hover:bg-neutral-900 transition-colors hidden sm:flex border border-transparent hover:border-red-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" wire:navigate class="flex items-center gap-2 px-4 py-2 text-xs font-bold uppercase tracking-widest text-white bg-red-600 hover:bg-red-700 transition-colors hidden sm:flex border border-red-600">
                        <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<nav id="default-nav" class="bg-white border-b border-gray-200 shadow-sm relative z-40 transition-all duration-300">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-6 lg:gap-8 py-3 overflow-x-auto whitespace-nowrap scrollbar-hide text-[13px] md:text-sm font-bold uppercase tracking-widest text-gray-800">
            <a href="<?php echo e(route('stream')); ?>" class="relative group hover:text-red-600 transition-colors pb-1 <?php echo e(request()->is('stream') ? 'text-red-600' : ''); ?>">
                Watch Live
                <span class="absolute bottom-0 left-0 w-full h-[3px] bg-red-600 transform origin-left transition-transform duration-200 <?php echo e(request()->is('stream') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'); ?>"></span>
            </a>
            ...
            <a href="<?php echo e($url); ?>" class="relative group hover:text-red-600 transition-colors pb-1 <?php echo e($isActive ? 'text-red-600' : ''); ?>">
...
</nav><?php /**PATH E:\livestream-apps\lusweti-online-center\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>