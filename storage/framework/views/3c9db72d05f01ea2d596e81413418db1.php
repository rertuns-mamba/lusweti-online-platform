        ...
        <div class="h-16 flex items-center justify-between">
            <div class="flex items-center gap-3 w-1/4 sm:w-1/3">
                <button id="menu-toggler"
                    ...
                    <svg class="h-6 w-6 sm:h-7 sm:w-7 group-hover:scale-105 transition-transform" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="square" stroke-linejoin="miter" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    <span
                        class="hidden md:block text-sm font-bold uppercase tracking-widest group-hover:text-white transition-colors">
            ...
            <div class="flex items-center justify-end gap-4 sm:gap-6 w-auto sm:w-1/3">
                ...
                <form action="<?php echo e(route('search')); ?>" method="GET" class="hidden lg:flex items-center flex-shrink-0">
                    <div
                        class="flex items-center bg-neutral-900 border border-neutral-700 overflow-hidden focus-within:border-neutral-400 transition-colors">
                        <input type="text" name="query" placeholder="Search news..."
                            class="w-32 xl:w-48 bg-transparent px-3 py-1.5 text-sm text-white placeholder-neutral-500 focus:outline-none">
                        <button type="submit"
                            class="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 transition-colors">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <div class="relative flex-shrink-0" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" class="flex items-center space-x-3 focus:outline-none p-1 group">
                            ...
                            <div
                                class="h-8 w-8 sm:h-9 sm:w-9 bg-neutral-800 border border-neutral-700 flex items-center justify-center overflow-hidden group-hover:border-red-600 transition-colors flex-shrink-0">
                ...
                <?php else: ?>
                    <div class="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                        <a href="<?php echo e(route('subscribe')); ?>"
                            class="flex items-center gap-2 px-3 py-2 text-xs font-bold uppercase tracking-widest text-red-500 hover:text-red-400 hover:bg-neutral-900 transition-colors hidden sm:flex border border-transparent hover:border-red-600">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('login')); ?>" wire:navigate
                                class="flex items-center gap-2 px-4 py-2 text-xs font-bold uppercase tracking-widest text-white bg-red-600 hover:bg-red-700 transition-colors hidden sm:flex border border-red-600">
                                <svg class="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<nav id="default-nav" class="relative z-40 transition-all duration-300 bg-white border-b border-gray-200 shadow-sm">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center gap-6 py-3 overflow-x-auto text-[13px] font-bold tracking-widest text-gray-800 uppercase whitespace-nowrap scrollbar-hide lg:gap-8 md:text-sm">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2418292429-0', $__key);
...
?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <a href="<?php echo e($url); ?>"
                    class="relative group hover:text-red-600 transition-colors pb-1 <?php echo e($isActive ? 'text-red-600' : ''); ?>">
                    <?php echo e($page->title); ?>

                    <span class="absolute bottom-0 left-0 w-full h-[3px] bg-red-600 transform origin-left transition-transform duration-200 <?php echo e($isActive ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'); ?>"></span>
                </a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2418292429-1', $__key);
...
unset($__split);
?>
<?php /**PATH E:\livestream-apps\lusweti-online-center\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>