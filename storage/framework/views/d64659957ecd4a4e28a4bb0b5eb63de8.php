...
<?php $__attrs94bfc109e12ed9dcf8cc8485ab944b12 = ['heading' => __('Platform'),'class' => 'grid']; ?>
...
<?php $__attrs3c3e385b75aa4f096985212ccb12554f = ['icon' => 'home','href' => route('dashboard'),'current' => request()->routeIs('dashboard'),'wire:navigate' => true]; ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
                <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/profile.blade.php', $__blaze->compiledPath.'/28c275c25d4e7af4fef43ecd6859ca6b.php'); ?>
<?php $__blaze->pushData(['initials' => auth()->user()->initials(),'iconTrailing' => 'chevron-down']); ?>
<?php _28c275c25d4e7af4fef43ecd6859ca6b($__blaze, ['initials' => auth()->user()->initials(),'iconTrailing' => 'chevron-down'], [], ['initials'], ['iconTrailing' => 'icon-trailing'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php /**PATH E:\livestream-apps\lusweti-online-center\resources\views\layouts\app\sidebar.blade.php ENDPATH**/ ?>