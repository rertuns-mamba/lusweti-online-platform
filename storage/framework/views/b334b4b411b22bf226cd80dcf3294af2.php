<?php
if (!function_exists('_b334b4b411b22bf226cd80dcf3294af2')):
function _b334b4b411b22bf226cd80dcf3294af2($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div class="<?php echo e($containerClasses); ?>">
    ...
    <?php if ($paginate): ?>
        ...
        <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/pagination.blade.php', $__blaze->compiledPath.'/3761e54f166be69bf91dc1d3a664e1b6.php'); ?>
<?php $__blaze->pushData(['attributes' => $paginationAttributes]); ?>
<?php _3761e54f166be69bf91dc1d3a664e1b6($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\table\index.blade.php ENDPATH**/ ?>