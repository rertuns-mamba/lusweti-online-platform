<?php # [BlazeFolded]:{flux::icon.chevron-left}:{E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php}:{1781799918} ?>
...
<?php # [BlazeFolded]:{flux::icon.chevron-left}:{E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php}:{1781799918} ?>
<?php
if (!function_exists('_6feb376156cd561da33068eb91c884b0')):
function _6feb376156cd561da33068eb91c884b0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
$paginator ??= $attributes['paginator'] ?? $__defaults['paginator']; unset($attributes['paginator']);
$scrollTo ??= $attributes['scroll-to'] ?? $attributes['scrollTo'] ?? $__defaults['scrollTo']; unset($attributes['scrollTo'], $attributes['scroll-to']);
unset($__defaults);
?>
            ...
            <div class="flex items-center bg-white border border-zinc-200 rounded-[8px] p-[1px] dark:bg-white/10 dark:border-white/10">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginator->onFirstPage()): ?>
                    <div class="flex justify-center items-center size-8 sm:size-6 rounded-[6px] text-zinc-300 dark:text-zinc-500">
                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-4 rtl:hidden" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
  <path fill-rule="evenodd" d="M9.78 4.22a.75.75 0 0 1 0 1.06L7.06 8l2.72 2.72a.75.75 0 1 1-1.06 1.06L5.47 8.53a.75.75 0 0 1 0-1.06l3.25-3.25a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd"/>
</svg>

        <?php echo ltrim(ob_get_clean()); ?>
                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-4 hidden rtl:inline" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\pagination.blade.php ENDPATH**/ ?>