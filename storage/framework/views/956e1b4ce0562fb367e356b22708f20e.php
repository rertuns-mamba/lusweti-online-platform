<?php # [BlazeFolded]:{flux::icon.chevron-down}:{E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-down.blade.php}:{1781799918} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1781799918} ?>
...
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1781799918} ?>
<?php
if (!function_exists('_956e1b4ce0562fb367e356b22708f20e')):
function _956e1b4ce0562fb367e356b22708f20e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _674a7ecd707d55f4e7014975fe11c342($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _674a7ecd707d55f4e7014975fe11c342($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
                ...
                <div class="hidden in-data-flux-menu:block">
                    <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php', $__blaze->compiledPath.'/62fbcda93178471b2a6635a98998e9cc.php'); ?>
...
<?php _62fbcda93178471b2a6635a98998e9cc($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/75c57016a3bba1ac7f8d7708dd50946d.php'); ?>
...
<?php _75c57016a3bba1ac7f8d7708dd50946d($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
>
    <?php ob_start(); ?>
                <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/51c1b8bf2b5d3d2b4bb7e35cb064b6ba.php'); ?>
<?php if (isset($__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba)) { $__slotsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba[] = $__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba; } ?>
<?php if (isset($__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba)) { $__attrsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba[] = $__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba; } ?>
<?php $__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba = ['heading' => $heading]; ?>
<?php $__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba = []; ?>
<?php $__blaze->pushData($__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba); ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba); ?>
<?php _51c1b8bf2b5d3d2b4bb7e35cb064b6ba($__blaze, $__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba, $__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba, ['heading'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba)) { $__slots51c1b8bf2b5d3d2b4bb7e35cb064b6ba = array_pop($__slotsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba); } ?>
<?php if (! empty($__attrsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba)) { $__attrs51c1b8bf2b5d3d2b4bb7e35cb064b6ba = array_pop($__attrsStack51c1b8bf2b5d3d2b4bb7e35cb064b6ba); } ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\sidebar\group.blade.php ENDPATH**/ ?>