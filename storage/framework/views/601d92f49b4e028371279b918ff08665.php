<?php
if (!function_exists('_601d92f49b4e028371279b918ff08665')):
function _601d92f49b4e028371279b918ff08665($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<th <?php echo e($attributes->class($classes)); ?> data-flux-column>
    <?php if ($sortable): ?>
        <div class="flex in-[.group\/center-align]:justify-center in-[.group\/end-align]:justify-end">
            <?php $__blaze->ensureRequired('E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\src/../stubs/resources/views/flux/table/sortable.blade.php', $__blaze->compiledPath.'/197997a3085034f9ab3230daf8a6f83b.php'); ?>
<?php if (isset($__slots197997a3085034f9ab3230daf8a6f83b)) { $__slotsStack197997a3085034f9ab3230daf8a6f83b[] = $__slots197997a3085034f9ab3230daf8a6f83b; } ?>
<?php if (isset($__attrs197997a3085034f9ab3230daf8a6f83b)) { $__attrsStack197997a3085034f9ab3230daf8a6f83b[] = $__attrs197997a3085034f9ab3230daf8a6f83b; } ?>
<?php $__attrs197997a3085034f9ab3230daf8a6f83b = ['sorted' => $sorted,'direction' => $direction]; ?>
<?php $__slots197997a3085034f9ab3230daf8a6f83b = []; ?>
<?php $__blaze->pushData($__attrs197997a3085034f9ab3230daf8a6f83b); ?>
<?php ob_start(); ?>
                <div><?php echo e($slot); ?></div>
            <?php $__slots197997a3085034f9ab3230daf8a6f83b['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots197997a3085034f9ab3230daf8a6f83b); ?>
<?php _197997a3085034f9ab3230daf8a6f83b($__blaze, $__attrs197997a3085034f9ab3230daf8a6f83b, $__slots197997a3085034f9ab3230daf8a6f83b, ['sorted', 'direction'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack197997a3085034f9ab3230daf8a6f83b)) { $__slots197997a3085034f9ab3230daf8a6f83b = array_pop($__slotsStack197997a3085034f9ab3230daf8a6f83b); } ?>
<?php if (! empty($__attrsStack197997a3085034f9ab3230daf8a6f83b)) { $__attrs197997a3085034f9ab3230daf8a6f83b = array_pop($__attrsStack197997a3085034f9ab3230daf8a6f83b); } ?>
<?php $__blaze->popData(); ?>
        </div>
    <?php else: ?>
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\table\column.blade.php ENDPATH**/ ?>