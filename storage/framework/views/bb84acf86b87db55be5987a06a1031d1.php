<?php
if (!function_exists('_bb84acf86b87db55be5987a06a1031d1')):
function _bb84acf86b87db55be5987a06a1031d1($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH E:\livestream-apps\lusweti-online-center\vendor\livewire\flux\stubs\resources\views\flux\icon\arrow-turn-up-right.blade.php ENDPATH**/ ?>